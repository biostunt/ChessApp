...
CMakeFiles/ChessApp.dir/Interface.cpp.o: CMakeFiles/ChessApp.dir/flags.make
CMakeFiles/ChessApp.dir/Interface.cpp.o: ../Interface.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/biostunt/CLionProjects/ChessApp/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Building CXX object CMakeFiles/ChessApp.dir/Interface.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/ChessApp.dir/Interface.cpp.o -c /home/biostunt/CLionProjects/ChessApp/Interface.cpp

CMakeFiles/ChessApp.dir/Interface.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/ChessApp.dir/Interface.cpp.i"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/biostunt/CLionProjects/ChessApp/Interface.cpp > CMakeFiles/ChessApp.dir/Interface.cpp.i

CMakeFiles/ChessApp.dir/Interface.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/ChessApp.dir/Interface.cpp.s"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/biostunt/CLionProjects/ChessApp/Interface.cpp -o CMakeFiles/ChessApp.dir/Interface.cpp.s

CMakeFiles/ChessApp.dir/CodeStatement.cpp.o: CMakeFiles/ChessApp.dir/flags.make
CMakeFiles/ChessApp.dir/CodeStatement.cpp.o: ../CodeStatement.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/biostunt/CLionProjects/ChessApp/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "Building CXX object CMakeFiles/ChessApp.dir/CodeStatement.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/ChessApp.dir/CodeStatement.cpp.o -c /home/biostunt/CLionProjects/ChessApp/CodeStatement.cpp

CMakeFiles/ChessApp.dir/CodeStatement.cpp.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing CXX source to CMakeFiles/ChessApp.dir/CodeStatement.cpp.i"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/biostunt/CLionProjects/ChessApp/CodeStatement.cpp > CMakeFiles/ChessApp.dir/CodeStatement.cpp.i

CMakeFiles/ChessApp.dir/CodeStatement.cpp.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling CXX source to assembly CMakeFiles/ChessApp.dir/CodeStatement.cpp.s"
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/biostunt/CLionProjects/ChessApp/CodeStatement.cpp -o CMakeFiles/ChessApp.dir/CodeStatement.cpp.s
...
ChessApp: CMakeFiles/ChessApp.dir/Interface.cpp.o
ChessApp: CMakeFiles/ChessApp.dir/CodeStatement.cpp.o
ChessApp: CMakeFiles/ChessApp.dir/build.make
ChessApp: CMakeFiles/ChessApp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/biostunt/CLionProjects/ChessApp/cmake-build-debug/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Linking CXX executable ChessApp"
